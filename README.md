...
1. Install the [aws_stackstorm-aws_kinesis-video-media pack](https://github.com/stackstorm-exchange/stackstorm-aws_stackstorm-aws_kinesis-video-media):

    ```
    # Install AWS
    st2 pack install aws_stackstorm-aws_kinesis-video-media

    # Check it
    st2 action list -p aws_stackstorm-aws_kinesis-video-media
    ```

2. Copy the example configuration in [aws.yaml.example](./aws.yaml.example)
to `/opt/stackstorm/configs/aws_stackstorm-aws_kinesis-video-media.yaml` and edit as required. It must contain:
...
Prior to installation of the aws pack, you can get the list of available actions here:
  ...
  https://github.com/StackStorm-Exchange/stackstorm-aws_stackstorm-aws_kinesis-video-media/tree/master/actions
...
```
source /opt/stackstorm/virtualenvs/aws_stackstorm-aws_kinesis-video-media/bin/activate
cd /opt/stackstorm/packs/aws_stackstorm-aws_kinesis-video-media/etc/st2packgen
python st2packgen.py -d /opt/stackstorm/packs/aws_stackstorm-aws_kinesis-video-media/actions
st2ctl reload --register-actions
```

`st2packgen.py` will overwrite any existing actions at `/opt/stackstorm/packs/aws_stackstorm-aws_kinesis-video-media/actions`.
